...
def station():
    # I WANT TO RETURN ALL ROWS FROM THE STATION TABLE
...
def precipitation():
    # I WANT TO RETURN ALL ROWS FROM THE Measurement TABLE, grouped by date, and avg precipitation
...
def temperature():
    # I WANT TO RETURN ALL ROWS FROM THE Measurement TABLE, for the most popular station, for the last year
